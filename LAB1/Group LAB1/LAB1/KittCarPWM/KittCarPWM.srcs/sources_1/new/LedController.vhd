...
begin
	...
	Tail	<= '1' when head = '1' and headReg = '0' else                   --PWM is imperfect therefore it cannot give a 100% duty cycle, here we force it
            	PWM;														--connects the PWM output @ the module output
end Behavioral;
